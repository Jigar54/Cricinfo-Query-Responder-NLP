...
files = [
    [""], ['', "11bat.txt", "11bowl.txt", "12bat.txt", "12bowl.txt", "1d.txt"], ['', "21bat.txt", "21bowl.txt", "22bat.txt", "22bowl.txt", "2d.txt"], ['', "31bat.txt", "31bowl.txt",
                                                                                                                                                       "32bat.txt", "32bowl.txt", "3d.txt"], ['', "41bat.txt", "41bowl.txt", "42bat.txt", "42bowl.txt", "4d.txt"], ['', "51bat.txt", "51bowl.txt", "52bat.txt", "52bowl.txt", "5d.txt"]]
...
# In case of draw nothing is writted to file
    if winner_flag == 0:
        ...
        for i in range(len(win)):
                stri = str(i)
                wind[stri] = win[i]
        pickle.dump(wind, open("win.p", "wb"))
        fp2.write("\n")
        fp2.close()
    ...
    for tr in range(1, len(rows)-n, 1):
        ...
        if len(com) > 2:
            ...
            if(len(l) > 0):
                ...
                print details
                d[x] = details
                pickle.dump(d, open(str(e)+str(g)+"comm.p", "wb"))
