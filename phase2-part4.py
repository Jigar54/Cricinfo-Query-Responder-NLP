...
def printingproperly(no, ball, match, qn):
    print "Match no:",
    print match
    if qn == "when" or qn == "When":
        print "BALL: ",
        print no,
    ...
    elif qn == "who" or qn == "Whom" or qn == "Who" or qn == "whom":
        print no,
        print " ",
        print ball['from'] + " to ",
        print ball['to']

    elif qn == "what" or qn == "What":
        print "On "
        print no,
        print " ,",
        print ball['why']

    elif qn == 'why' or qn == "Why":
        print "At the time when "
        print no,
        print " was bowled this event happend because,",
        print ball['why']

    elif qn == "How " or qn == "how":
        print "On "
        print no,
        print " ,",
        print ball['what']
...
diction1 = parsecomm(dic)
diction2 = parsecomm(dic2)
print "Still processing ....\n"
print
result = findmatch(query, diction1, diction2, dic, dic2, table, table2)
